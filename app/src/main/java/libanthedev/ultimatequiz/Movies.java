...
public class Movies extends Activity {
    ...
    private TrueFalse [] mQuestionBank = new TrueFalse[]{
            new TrueFalse(R.string.movie_question_1, true),
            new TrueFalse(R.string.movie_question_2, true),
            new TrueFalse(R.string.movie_question_3, true),
            new TrueFalse(R.string.movie_question_4, true),
            new TrueFalse(R.string.movie_question_5, true),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Welcome to the Movies Quiz", Toast.LENGTH_SHORT).show();
